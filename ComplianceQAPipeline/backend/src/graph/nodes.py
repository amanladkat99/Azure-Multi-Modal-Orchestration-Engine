...
# VideoAuditState - contains video_url as a input
def index_video_node(state: VideoAuditState) -> Dict[str, Any]:
    """
    Downloads YouTube video from the url, uploads to Azure VI, and extracts insights.
    """
...
def audit_content_node(state: VideoAuditState) -> Dict[str, Any]:
    ...
    llm = AzureChatOpenAI(
        azure_deployment=os.getenv("AZURE_OPENAI_CHAT_DEPLOYMENT"),
        azure_endpoint=os.getenv("AZURE_OPENAI_ENDPOINT"),   # ✅ add this
        api_key=os.getenv("AZURE_OPENAI_API_KEY"),           # ✅ add this
        openai_api_version=os.getenv("AZURE_OPENAI_API_VERSION"),
        temperature=0.0
    )
    ...
    embeddings = AzureOpenAIEmbeddings(
        azure_deployment="text-embedding-3-small",
        azure_endpoint=os.getenv("AZURE_OPENAI_ENDPOINT"),   # ✅ REQUIRED
