...
# Error Report - This ensures structural consistency for every issue detected by the AI.
...
class VideoAuditState(TypedDict):
    ...
    Main Container : Holds all the informantion about the audit 
    ...
    # Store the list of all the violations found by the AI
    ...
    # Stores the list of syystem level crashes
